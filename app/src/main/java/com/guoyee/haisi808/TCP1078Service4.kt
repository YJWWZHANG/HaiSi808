 ...
 *创建时间:2019/1/9 16:24
 */
class TCP1078Service4: Service() {

    private val mTcpVideoPort: Int = 5003
        ...
        override fun run() {
            ...
            while (!isInterrupted) {
                try {
                    ...
                    LogUtils.e("TCP1078_4视频已经成功连接")
                    ToastUtils.showLong("TCP1078_4视频已经成功连接")
...
//                        LogUtils.e("$binaryString $tag")
                        when(tag) {
                            0.toByte() -> {     //原子包
                                ...
                                EventBus.getDefault().post(ShowVideo4Event(Bytes.toArray(mDataBufferList)))
